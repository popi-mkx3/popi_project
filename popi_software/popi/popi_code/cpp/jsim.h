#ifndef IIT_POPI_JSIM_H_
#define IIT_POPI_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot popi.
 */
class JSIM : public iit::rbd::StateDependentMatrix<iit::popi::JointState, 18, 18, JSIM>
{
    private:
        typedef iit::rbd::StateDependentMatrix<iit::popi::JointState, 18, 18, JSIM> Base;
    public:
