^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package popi_control
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

0.5.0 (2019-09-18)
------------------
* Merge pull request `#20 <https://github.com/PickNikRobotics/popi_control/issues/20>`_ from ipa-mdl/fix-loop-deadlock
  refactor GenericHWControlLoop to a sleep-based loop
* Merge pull request `#19 <https://github.com/PickNikRobotics/popi_control/issues/19>`_ from PaulBouchier/kinetic-devel
  change sim_control_mode to 0 (position) so demo works
* Merge pull request `#21 <https://github.com/PickNikRobotics/popi_control/issues/21>`_ from MohmadAyman/fix_typo
...
* change sim_control_mode to 0 (position) so demo works
* Merge pull request `#16 <https://github.com/PickNikRobotics/popi_control/issues/16>`_ from lucasw/xml-version
  xml version tags for all launch files.
* xml version tags for all launch files.
* Merge pull request `#15 <https://github.com/PickNikRobotics/popi_control/issues/15>`_ from enricotoi/kinetic-devel
  Fixed a typo in the README.md
* Fixed a typo in the README.md
  popi_simulaton.launch -> popi_simulation.launch
* Update README.md
...
0.2.1 (2015-12-09)
------------------
* Merge branch 'indigo-devel' of github.com:davetcoleman/popi_control into indigo-devel
* Fix install path
...
* Improved popi_control example package
* Moved popi example code into subdirectory
* Contributors: Dave Coleman
...
0.1.0 (2015-12-02)
------------------
* Initial release of popi_control
* Contributors: Dave Coleman
